...
bool LinkDatabase()//连接图书馆数据库
{
	...
	::GetPrivateProfileString(_T("LIB"),_T("IPAddress"),_T("192.168.1.101"),strIP.GetBuffer(30),30,_T(".\\LibraryServer.ini"));
	strIP.ReleaseBuffer();
	...
	strSQL.Format(_T("Provider=OraOLEDB.Oracle.1;User ID=%s;Password=%s;Data Source=%s;Persist Security Info=False"),strUserName,strTemp,/*strIP,*/strLibName);
	...
	//		m_Connection->Open ("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=myTestDB.mdb","","",adModeUnknown);
//biaoji 	hr = m_Connection->Open("Provider=OraOLEDB.Oracle.1;User ID=libuser;Password=134;Data Source=192.168.1.101/LIBRARY;Persist Security Info=False","","",adOpenUnspecified);
	//		hr = m_Connection->Open("Provider=OraOLEDB.Oracle.1;User ID=libuser;Password=134;Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.1.101)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME = library)));Persist Security Info=False","","",adOpenUnspecified);
